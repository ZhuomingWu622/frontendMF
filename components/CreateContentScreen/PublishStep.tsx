...
export const PublishStep: FC<PublishStepProps> = ({setStep,videoUri}) => {
    ...
    const handlePublish = async() =>{
        ...
        try{
            ...
            const uploadVideoResponse = await FileSystem.uploadAsync(`${BASE_URL}/api/v1/video/upload`,videoUri,{
            ...
            const {videoUrl} = JSON.parse(uploadVideoResponse.body) as UploadVideoApiResponse;

            const uploadImageResponse = await FileSystem.uploadAsync(`${BASE_URL}/api/v1/video/coverImage`,imageUri,{
            ...
            const {imageUrl} = JSON.parse(uploadImageResponse.body) as UploadCoverImageApiResponse;

            await axios.post(`${BASE_URL}/api/v1/video/new`,{
                restaurantName,
                postTitle:postName,
                videoUrl,
                imageUrl
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                placeholder="Enter post name (up tp 50 characters)"
                ...
                <View style={styles.footerContainer}>
                    {errorMessage && <Text style={{color:"#ec1313"}}>{errorMessage}</Text>}
